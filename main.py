"""Unified main entry point for the plan reuse system."""
...
class PlanReuseSystem:
    """Main system orchestrating plan reuse functionality."""
    ...
    def run(self) -> None:
        """Run the complete plan reuse system."""
        print("="*60)
        print("PLAN REUSE SYSTEM")
        print("="*60)
